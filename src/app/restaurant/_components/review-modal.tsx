  ...
  return (
    <>
      <Credenza>
        <div className="w-full h-full bg-secondary rounded-lg p-6 lg:p-8">
          <div className="flex flex-col gap-4">
            <div className="w-full flex justify-between items-start">
              ...
              <p className="text-sm lg:text-base text-gray-500 hidden lg:flex">
                {totalItems}&nbsp;Ratings
              </p>
              <div className="flex lg:hidden flex-col w-[20%] min-w-fit justify-start items-center ">
                ...
                <p className="text-sm lg:text-base text-nowrap text-gray-500">
                  out of {totalItems}
                </p>
              </div>
            </div>
        ...
        <CredenzaContent>
          <CredenzaHeader>
            <CredenzaTitle className="font-medium text-base lg:text-2xl">
              Leave a review
            </CredenzaTitle>
          </CredenzaHeader>
          <CredenzaBody>
